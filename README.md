...
* Names and wait times are saved automatically so the app can be restarted if needed.
...
* `s` saves student info. Student info is automatically saved every 30 seconds by default.
